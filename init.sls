...
/usr/lib/nagios/plugins/check_cpu:
  file.managed:
    ...
    - source_hash: 107fe41e65915de0817cbdc4399f2767add721cc4abffe2827d37d65dc8fad51
    - mode: '0755'

/usr/lib/nagios/plugins/check_linux_memory:
  file.managed:
    - source: https://s3.amazonaws.com/monitoring-plugins/Linux/check_linux_memory
    - source_hash: d21e46c68e9bfd665a04929a68ddfdc9e6bf2bae675768de209494b9fb86aa21
    - mode: '0755'

/usr/lib/nagios/plugins/check_logfiles:
  file.managed:
    - source: https://s3.amazonaws.com/monitoring-plugins/Linux/check_logfiles
    - source_hash: 9b4fcbc1634179d7bd7adcf77a56b6bf3603eb82c1ff133a8962591f0e1130a1
    - mode: '0755'
